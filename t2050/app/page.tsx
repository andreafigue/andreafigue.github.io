...
export default async function ChoroplethPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8" style={{ margin: '40px', width: '800px'}}>
      ...
      <p className="mt-4 mb-8">
        Now it’s your turn to explore the future. Our interactive dashboard brings together all 
        the data—population growth projections, commute times, transportation infrastructure 
        scenarios, and more—into one easy-to-use platform. Dive deep into the trends, compare 
        different future scenarios, and see exactly how changes will impact your daily life, 
        from commute times to air travel wait times. Whether you’re a commuter, policymaker, or 
        simply curious about the region’s future, this dashboard empowers you to make informed 
        decisions, understand the trade-offs, and envision a Cascadia that works for everyone.
      </p>
